Ajouter, modifier ou supprimer le transport des élèves dans cette page.
</hr> 
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?teacher/transport/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success"><?php echo get_phrase('add_transport');?></button>
                              </div>
                            </div>
                    </form>                
                </div>                
