Cette page vous permet de regarder les notes obtenues sur les devoirs et/ou compositions.</br>
Vous pouvez envoyer des messages aux enseignants si vous avez des réclammations à faire. </br>
Pour cela rendez-vous dans <a href="<?php echo base_url(); ?>index.php?student/message/message_new"> Message </a>. 
</hr>
<div class="row">
	<div class="col-md-12">
                	...
                	<tr>
                        ...
                        <td>
                         <input type="hidden" name="class_id" value="<?php echo $class_id;?>" />
                    		...
                    		<input type="submit" value="Voir mes notes" class="btn btn-info" />
                        </td>
                	</tr>
                </table>
                </form>
