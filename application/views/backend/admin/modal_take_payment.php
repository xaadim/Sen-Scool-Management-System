            ...
            <div class="panel-body">
				<?php echo form_open(base_url() . 'index.php?admin/invoice/take_payment/'.$row['invoice_id'], array(
					...
					<div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" value="<?php echo number_format($row['amount'], 0, '.', ' ').' FCFA';?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" name="amount_paid" value="<?php echo number_format($row['amount_paid'], 0, '.', ' ').' FCFA';?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" value="<?php echo number_format($row['due'], 0, '.', ' ').' FCFA';?>" readonly/>
		                </div>
		            </div>
