Cette page permet de gérer tous les frais ou dépenses de l'école. Plusieurs catégories ont été ajoutées par défaut<br>
mais vous pouvez en ajouter d'autres dans <a href="<?php echo base_url();?>index.php?admin/expense_category">Catégories</a><br>
...
<table class="table table-bordered datatable" id="table_export">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <?php echo number_format($row['amount'], 0, '.', ' ').' FCFA';?></td>
