Cette page vous permet de donner les notes et appréciations aux élèves sur les devoirs et/ou compositions.</br>
N'oubliez pas d'enregistrer chaque ligne. </br>
</hr>
<div class="row">
    <div class="col-md-12">
        ...
        <!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                    <tr>
                        <td>Sélectionner un devoir ou une composition</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php 
                                ...
                                <select name="<?php if($class_id == $row1['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                      id="subject_id_<?php echo $row1['class_id'];?>" 
                                          style="display:<?php if($class_id == $row1['class_id'])echo 'block';else echo 'none';?>;" class="form-control"  style="float:left;">
                                  
                                    <option value="">Sujet de la classe <?php echo $row1['name'];?></option>
                ...
                <h4 style="">
                    ...
                    <?php echo 'Edition des notes '?>
                   <!--  <?php echo 'sujet'?>
                    <?php echo 'de '.$exam_name?>
                    <?php echo $row1['name']?> -->
                </h4>
                Enregistrer la ligne en cours avant de passer à une autre</br>
