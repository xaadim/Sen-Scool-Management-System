Ajouter ici tous vos devoirs et compostions à faits dans l'école. Cela vous permettra par la suite de donner des notes aux élèves<br>
et des appréciations. Les parents aussi pourront directement voir les notes de leurs enfants une fois publiées.
<div class="row">
	<div class="col-md-12">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('comment_exam');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php
                                    ...
                                    $dateFr = date("d-m-Y", strtotime($originalDate));
                                    echo $dateFr;
                                ?>
                            </td>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/exam/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="date"/> Format: mois/jour/année
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('comment_exam');?></label>
                                <div class="col-sm-5">
