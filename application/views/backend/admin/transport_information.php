...
<a href="<?php echo base_url();?>index.php?admin/student_information_all" 
    class="btn btn-primary pull-right">
        ...
        Ajouter un élève dans ce transport 
    </a> 
<br>
        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs">Elèves dans ce transport</span>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        <?php 
                                $students   =   $this->db->get_where('student' , array('transport_id'=>$transport_id))->result_array();
