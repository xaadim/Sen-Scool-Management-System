Cette page vous permet de réinscrire un élève. Entrer le matricule de l'élève pour commencer.</br>
<hr/>
<br>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Entrer le matricule">
        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs">Tous les élèves</span>
                </a>
            </li>
        <?php 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    <button type="button" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_student_edit/<?php echo $row['student_id'];?>');" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown">
                                        Réinscrire 
                                    </button>
                                </div>
