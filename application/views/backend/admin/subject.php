Gestion des disciplines de l'école par classe. Ajouter, modifier ou supprimer...
<div class="row">
    <div class="col-md-12">
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/subject/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Français, Maths, ou Arabe" class="form-control" name="name" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                                </div>
                            </div>
                            <div class="form-group">
