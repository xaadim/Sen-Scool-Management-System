Gestion des emplois du temps de l'école. 
<div class="row">
	<div class="col-md-12">
					...
					foreach($classes as $row):
						?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse<?php echo $row['class_id'];?>" class="panel-collapse collapse <?php if($toggle){echo '';$toggle=false;}?>">
                                    <div class="panel-body">
                                        <table cellpadding="0" cellspacing="0" border="0"  class="table table-bordered">
                                            <tbody>
                                                ...
                                                else if($d==6)$day='vendredi';
                                                else if($d==7)$day='dimanche';
                                                ?>
                                                <tr class="gradeA">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/class_routine/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('discpline');?></label>
                                <div class="col-sm-5">
