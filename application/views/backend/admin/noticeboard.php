Cette page vous permet de gérer vos avis et événements à diffuser à tout le monde ayant un accès autorisé à l'application <br>
(parents, professeurs, élèves et administraueurs). La date de l'événement ou de l'avis sera automatiquement ajoutée dans le calendrier depuis la page d'accueil.<br>
Vous pouvez (si la fonction est configurée et active) envoyer l'avis ou l'événement sous forme de SMS.
<hr>
<div class="row">
	<div class="col-md-12">
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/noticeboard/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                                ...
                                <div class="col-sm-5">
                                    <div class="box closable-chat-box">
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="notice" id="ttt" rows="5" placeholder="<?php echo get_phrase('notice');?>" class="form-control"></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-success"><?php echo get_phrase('add');?></button>
                            </div>
						</div>
                    </form>                
                </div>                
