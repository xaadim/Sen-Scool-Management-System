Cette page est conçue pour envoyer via SMS les notes des devoirs et/ou compositions aux parents par exemple. </br>
Pour configurer le service SMS, rendez-vous dans <a href="<?php echo base_url(); ?>index.php?admin/sms_settings"> Paramètre SMS </a>
