                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="text_align" class="form-control">
                              ...
                              <option value="left-to-right" <?php if ($text_align == 'left-to-right')echo 'selected';?>> Gauche à droite</option>
                              <option value="right-to-left" <?php if ($text_align == 'right-to-left')echo 'selected';?>> Droite à gauche</option>
                          </select>
                      </div>
                  </div>
            ...
            'class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
              ...
              <div class="panel panel-primary" >
                  ...
                  <div class="panel-body">
                              ...
                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  <div>
                                      <span class="btn btn-white btn-file">
                                          <span class="fileinput-new">Sélectionnez un logo</span>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-3 col-sm-9">
                          <button type="submit" class="btn btn-success"><?php echo get_phrase('upload').' ';?>le logo</button>
                      </div>
                    </div>
