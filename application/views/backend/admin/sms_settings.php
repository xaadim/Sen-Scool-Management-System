Cliquer sur le nom d'un service pour le configuer.
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="tabs-vertical-env">
			...
			<li class="active"><a href="#b-profile" data-toggle="tab">Choisissez un service SMS</a></li>
				<li>
				...
				<div class="tab-pane active" id="b-profile">
					...
					<div class="form-group">
	                    <div class="col-sm-offset-3 col-sm-5">
	                        <button type="submit" class="btn btn-success">Activer le service</button>
	                    </div>
	                </div>
	            <?php echo form_close();?>
				</div>
