Ajouter, modifier ou supprimer des livres dans votre bibliothèque.<br>
</hr>
<div class="row">
	<div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="status" class="form-control" style="width:100%;">
                                    	<option value="Disponible"><?php echo get_phrase('available');?></option>
                                    	<option value="Indisponible"><?php echo get_phrase('unavailable');?></option>
                                    </select>
                                </div>
                            </div>
                        		<div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success"><?php echo get_phrase('add_book');?></button>
                              </div>
								</div>
                    </form>                
                </div>                
