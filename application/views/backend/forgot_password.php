        ...
        <div class="login-container">
            ...
            <div class="login-header login-caret">
                ...
                <div class="login-content" style="width:100%;">
                    ...
                    <p class="description">Entrer votre adresse e-mail pour réinitialiser votre mot de passe.</p>
                    <p class="description">Si vous avez des difficultés, veuillez contacter l'admistrateur : admin@keurbadianemai.com</p>

                    <!-- progress bar indicator -->
                    <div class="login-progressbar-indicator">
                        <h3>43%</h3>
                        <span>Réinitialisation du mot de passe en cours...</span>
                    </div>
                </div>
            ...
            <div class="login-form">
                ...
                <div class="login-content">
                    ...
                    <div class="form-login-error">
                        <h3>Connexion incorrecte</h3>
                        <p>Veuillez entrer une adresse email valide et un mot de passe!</p>
                    </div>
                    <form method="post" role="form" id="form_forgot_password">

                        <div class="form-forgotpassword-success">
                            <i class="entypo-check"></i>
                            <h3>L'e-mail de réinitialisation du mot de passe envoyé.</h3>
                            <p>Veuillez consulter vos mails, les instructions sont envoyés!</p>
                        </div>
